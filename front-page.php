...
<section
  style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/banner-1.jpg'); background-repeat: no-repeat; background-size: cover;">
  <div class="container-lg">
    <div class="row">
      <div class="col-lg-6 pt-5 mt-5">
        <h2 class="display-1 ls-1"><span class="fw-bold text-primary">Organic</span> Foods at your <span
            class="fw-bold">Kaddora</span></h2>
      ...
      <div class="col-md-12">
        ...
        <div class="category-carousel swiper">
          <div class="swiper-wrapper">
            <a href="/categories" class="nav-link swiper-slide text-center">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/category-thumb-1.jpg"
                class="rounded-circle" alt="Category Thumbnail">
              <h4 class="fs-6 mt-3 fw-normal category-title">Fruits & Veges</h4>
            </a>
            <a href="/categories" class="nav-link swiper-slide text-center">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/category-thumb-2.jpg"
                class="rounded-circle" alt="Category Thumbnail">
              <h4 class="fs-6 mt-3 fw-normal category-title">Breads & Sweets</h4>
            </a>
            <a href="/categories" class="nav-link swiper-slide text-center">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/category-thumb-3.jpg"
                class="rounded-circle" alt="Category Thumbnail">
              <h4 class="fs-6 mt-3 fw-normal category-title">Fruits & Veges</h4>
            </a>
            <a href="/categories" class="nav-link swiper-slide text-center">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/category-thumb-4.jpg"
                class="rounded-circle" alt="Category Thumbnail">
              <h4 class="fs-6 mt-3 fw-normal category-title">Beverages</h4>
            </a>
            <a href="/categories" class="nav-link swiper-slide text-center">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/category-thumb-5.jpg"
                class="rounded-circle" alt="Category Thumbnail">
              <h4 class="fs-6 mt-3 fw-normal category-title">Meat Products</h4>
            </a>
            <a href="/categories" class="nav-link swiper-slide text-center">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/category-thumb-6.jpg"
                class="rounded-circle" alt="Category Thumbnail">
              <h4 class="fs-6 mt-3 fw-normal category-title">Breads</h4>
            </a>
            <a href="/categories" class="nav-link swiper-slide text-center">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/category-thumb-7.jpg"
                class="rounded-circle" alt="Category Thumbnail">
              <h4 class="fs-6 mt-3 fw-normal category-title">Fruits & Veges</h4>
            </a>
            <a href="/categories" class="nav-link swiper-slide text-center">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/category-thumb-8.jpg"
                class="rounded-circle" alt="Category Thumbnail">
              <h4 class="fs-6 mt-3 fw-normal category-title">Breads & Sweets</h4>
            </a>
            <a href="/categories" class="nav-link swiper-slide text-center">
        ...
        <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5">
          ...
          $args = array(
            ...
            'tax_query' => array(
              array(
                ...
                'field' => 'slug',
                'terms' => 'best-selling-product', // tag slug
              ),
            ),
          );
          ...
          if ($loop->have_posts()):
            while ($loop->have_posts()):
              ...
              global $product;
              ?>
              <!-- your product item HTML stays the same -->
              <div class="col">
                <div class="product-item">
                  <figure>
                    <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
                      <?php if (has_post_thumbnail()) {
                        the_post_thumbnail('medium', array('class' => 'tab-image'));
                      } else { ?>
                        <img src="<?php echo wc_placeholder_img_src(); ?>" alt="Placeholder" class="tab-image">
                      <?php } ?>
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal"><?php the_title(); ?></h3>
                    <div>
                      <span class="rating">
                        <?php
                    ...
                    <div class="d-flex justify-content-center align-items-center gap-2">
                      <?php if ($product->is_on_sale()): ?>
                        ...
                        <span class="text-dark fw-semibold"><?php echo wc_price($product->get_sale_price()); ?></span>
                    ...
                    <div class="button-area p-3 pt-0">
                      <div class="row g-1 mt-2">
                        ...
                        <div class="col-7">
                          <a href="<?php echo esc_url(wc_get_cart_url()); ?>?add-to-cart=<?php echo $product->get_id(); ?>"
                        ...
                        <div class="col-2">
                          <a href="<?php echo esc_url(add_query_arg('add_to_wishlist', $product->get_id(), get_permalink())); ?>"
      ...
      <div class="col-md-12">
        ...
        <div class="banner-blocks">
          ...
          <div class="banner-ad d-flex align-items-center large bg-info block-1"
            style="background: url('<?php echo get_template_directory_uri(); ?>/assets/images/banner-ad-1.jpg') no-repeat; background-size: cover;">
            <div class="banner-content p-5">
              <div class="content-wrapper text-light">
                <h3 class="banner-title text-light">Items on SALE</h3>
                <p>Discounts up to 30%</p>
                <a href="/Products" class="btn-link text-white">Shop Now</a>
              </div>
            </div>
          </div>

          <div class="banner-ad bg-success-subtle block-2"
            style="background:url('<?php echo get_template_directory_uri(); ?>/assets/images/banner-ad-2.jpg') no-repeat;background-size: cover">
          ...
          <div class="banner-ad bg-danger block-3"
            style="background:url('<?php echo get_template_directory_uri(); ?>/assets/images/banner-ad-3.jpg') no-repeat;background-size: cover">
            <div class="banner-content align-items-center p-5">
              <div class="content-wrapper text-light">
  ...
  <div class="container-lg overflow-hidden py-5">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="swiper">
          <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5 swiper-wrapper">
          ...
          $args = array(
            ...
            'tax_query' => array(
              array(
                'taxonomy' => 'product_tag',
                'field' => 'slug',
                'terms' => 'most-popular-product', // tag slug
              ),
            ),
          );
...
<section>
  <div class="container-lg">
    ...
    <div class="bg-secondary text-light py-5 my-5"
      style="background: url('<?php echo get_template_directory_uri(); ?>/assets/images/banner-newsletter.jpg') no-repeat; background-size: cover;">
      <div class="container">
  ...
  <div class="container-lg overflow-hidden pb-5">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="swiper">
          <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5 new-lunch">
          ...
          $args = array(
            ...
            'tax_query' => array(
              array(
                'taxonomy' => 'product_tag',
                'field' => 'slug',
                'terms' => 'new-lunch-product', // tag slug
              ),
            ),
          );
    ...
    <div class="row">
      <div class="col-md-4">
        <article class="post-item card border-0 shadow-sm p-3">
          <div class="image-holder zoom-effect">
            <a href="#">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/post-thumbnail-1.jpg" alt="post"
                class="card-img-top">
            </a>
          </div>
          <div class="card-body">
      ...
      <div class="col-md-4">
        <article class="post-item card border-0 shadow-sm p-3">
          <div class="image-holder zoom-effect">
            <a href="#">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/post-thumbnail-2.jpg" alt="post"
                class="card-img-top">
            </a>
          </div>
          <div class="card-body">
      ...
      <div class="col-md-4">
        <article class="post-item card border-0 shadow-sm p-3">
          <div class="image-holder zoom-effect">
            <a href="#">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/post-thumbnail-3.jpg" alt="post"
                class="card-img-top">
            </a>
          </div>
          <div class="card-body">
          ...
          <div class="col-md-4">
            ...
            <div class="d-flex gap-2 flex-wrap mb-5">
              <a href="#" title="App store"><img
                  src="<?php echo get_template_directory_uri(); ?>/assets/images/img-app-store.png" alt="app-store"></a>
              <a href="#" title="Google Play"><img
                  src="<?php echo get_template_directory_uri(); ?>/assets/images/img-google-play.png"
                  alt="google-play"></a>
            </div>
          </div>
          <div class="col-md-5">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/banner-onlineapp.png" alt="phone"
              class="img-fluid">
          </div>
        </div>
      </div>
